...
class Provincia(models.Model):
    ...
    id_region = models.ForeignKey(
        'Region', models.DO_NOTHING, db_column='id_region')
...
class Comuna(models.Model):
    ...
    detalle_comuna = models.CharField(max_length=40, blank=True, null=True)
...
class Usuario(AbstractBaseUser, PermissionsMixin, models.Model):
    ...
    id_tipo_usuario = models.ForeignKey(
        TipoUsuario, models.DO_NOTHING, db_column='id_tipo_usuario', default=1)
    id_comuna = models.ForeignKey(
        Comuna, models.DO_NOTHING, db_column='id_comuna', blank=True, null=True)
    fecha_creacion = models.DateField(blank=True, null=True)
    fecha_modificacion = models.DateField(blank=True, null=True)
    fecha_eliminacion = models.DateField(blank=True, null=True)
    id_cliente = models.AutoField(primary_key=True)
    is_staff = models.FloatField(blank=True, null=True, default=0)
    is_active = models.FloatField(blank=True, null=True, default=1)
    last_login = models.DateTimeField(blank=True, null=True)
    is_superuser = models.FloatField(blank=True, null=True, default=0)
...
class Subasta(models.Model):
    ...
    id_seguro = models.ForeignKey(
        Seguro, models.DO_NOTHING, db_column='id_seguro', blank=True, null=True)
...
class Transporte(models.Model):
    ...
    id_cliente = models.ForeignKey(
        Usuario, models.DO_NOTHING, db_column='id_cliente')
...
class DetalleVenta(models.Model):
    ...
    id_moneda = models.ForeignKey(
        'Moneda', models.DO_NOTHING, db_column='id_moneda')
...
class ProcesoVenta(models.Model):
    ...
    id_contrato = models.ForeignKey(
        Contrato, models.DO_NOTHING, db_column='id_contrato', blank=True, null=True)
    id_dventa = models.ForeignKey(
        DetalleVenta, models.DO_NOTHING, db_column='id_dventa', blank=True, null=True)
    id_subasta = models.ForeignKey(
        'Subasta', models.DO_NOTHING, db_column='id_subasta', blank=True, null=True)
...
class BrProductosProcesoDeVenta(models.Model):
    ...
    id_pventa = models.ForeignKey(
        'ProcesoVenta', models.DO_NOTHING, db_column='id_pventa')
...
class Producto(models.Model):
    ...
    id_estado = models.ForeignKey(
        EstadoProducto, models.DO_NOTHING, db_column='id_estado')
    id_calidad = models.ForeignKey(
        CalidadProducto, models.DO_NOTHING, db_column='id_calidad')
    id_formato = models.ForeignKey(
        FormatoProducto, models.DO_NOTHING, db_column='id_formato')
    id_inventario = models.ForeignKey(
        Inventario, models.DO_NOTHING, db_column='id_inventario', blank=True, null=True)
    ...
    def __str__(self):
        return f'{self.nombre_producto} {self.id_formato}'
