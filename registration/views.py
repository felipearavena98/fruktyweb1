...
def producto(nombre, descripcion, cantidad, calidad, formato, precio_unitario, id_cliente, imagen ):
    django_cursor = connection.cursor()
    cursor = django_cursor.connection.cursor()
    salida = cursor.var(cx_Oracle.NUMBER)
    cursor.callproc('sp_producto_inventario', [
                    nombre, descripcion, cantidad, calidad, formato, precio_unitario, id_cliente, imagen, salida])
    return salida.getvalue()
...
def nuevo_Producto(request):
    if request.method == 'POST':
        ...
        salida = producto(nombre, descripcion, cantidad,
                          calidad, formato, precio_unitario, id_cliente, imagen)
        mensaje = salida
    else:
        mensaje = ''
...
def listado_productos(request):
    ...
    return render(request, 'registration/listado.html', {'lista': lista})
